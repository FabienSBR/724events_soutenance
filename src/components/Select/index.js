// Implémente un menu déroulant interactif avec des fonctionnalités de sélection d'option, personnalisation, et gestion d'état
...
const Select = ({
  ...
  const changeValue = (newValue) => {
    setValue(newValue);
    setCollapsed(true); // Réduit le menu déroulant ; on a remplacé 'newValue' par 'true'
    onChange(newValue); // Ajout ; notifie le parent de la nouvelle valeur choisie (indispensable pour fonctionnement de l'affichage des events par catégorie)
  };
